...
public class TestPodesavanja {
	...
	@Test
	public void testPodesavanja() throws InterruptedException {
	    ...
	    driver.get("https://www.halooglasi.com/profil/podesavanja");
	    Thread.sleep(2000);
	    driver.findElement(By.xpath("/html/body/div[3]/div[3]/div/div[2]/div/div/div/div/div/div[2]/div/div[7]/div/div/div[3]/div/div[1]/div/div/div[3]/div[1]/div/div/div/input")).click();
	    driver.findElement(By.xpath("/html/body/div[3]/div[3]/div/div[2]/div/div/div/div/div/div[2]/div/div[7]/div/div/div[3]/div/div[2]/div/div[1]/button")).click();
	    
	    String text = "Ime testa: TestPodesavanja\nDeskripcija: Automatsko testiranje promene podesavanja\nTest successful\n\n";
	    
		log.info(text);
		File dir = new File("C:\\Users\\Dell\\eclipse-workspace\\Testiranje2\\Projekat2\\src\\Reports");
		File reportFile = new File(dir,"TestPodesavanja-report.txt");
